			...
			if($comandaDetaliat[$i][0]== 'carte')
				{
					...
					<table border="3px">
					<tr>
					<td rowspan="10" width="100px"><img src="src/carte.png" width="100" height="100"></td></tr>
					<tr><td>Titlu: '.$comandaDetaliat[$i][1].'</td></tr>
					<tr><td>Format: '.$comandaDetaliat[$i][2].'</td></tr>
					<tr><td>Pagini: '.$comandaDetaliat[$i][3].'</td>
					</tr>
					<tr><td>numar pagini: '.$comandaDetaliat[$i][4].'</td></tr>
					<tr>
					<td>Hartie: '.$comandaDetaliat[$i][5].'</td></tr>
					<tr><td>Print coperta: '.$comandaDetaliat[$i][6].'</td></tr>
			...
			elseif($comandaDetaliat[$i][0]=='calendar-perete')
				{
					...
					<tr><td>Pret: '.$comandaDetaliat[$i][4].'</td>
					</tr>
					</table>
					';
				}
			elseif($comandaDetaliat[$i][0]=='flyer')
				{
					...
					<tr><td>Pret: '.$comandaDetaliat[$i][5].'</td>
					</tr>
					</table>
					';
				}
...
<center>
	<br /><a href="pdf.php?nr_comanda=<?php echo $nr_comanda;?>&id_client=<?php echo $id_client;?>" class="btn">Factura</a>
	<form method="POST"><br /><button name="inapoi" class="btn">inapoi</button></form>
	<?php if (isset($_POST['inapoi']))
	 {
		header("Location: contCL.php");
	}?>
</center>
